...
- [Transformers From Scratch (PyTorch)](https://github.com/bguevel/LLM1) — Group project implementing and training autoregressive Transformers (multi-head + single-head) on Wikipedia summaries and *Frankenstein*, including dynamic vocab and checkpointed training. Hosted under a teammate's account.
